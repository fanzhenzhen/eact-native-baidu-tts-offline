package com.fanzhen.baiduvoice;
...
import com.fanzhen.baiduvoice.control.InitConfig;
import com.fanzhen.baiduvoice.control.MySyntherizer;
import com.fanzhen.baiduvoice.control.NonBlockSyntherizer;
import com.fanzhen.baiduvoice.listener.UiMessageListener;
import com.fanzhen.baiduvoice.util.AutoCheck;
import com.fanzhen.baiduvoice.util.OfflineResource;
...
public class VoiceUtils {
    ...
    // TtsMode.MIX; 离在线融合，在线优先； TtsMode.ONLINE 纯在线； 纯离线 OFFLINE 
    ...
    public void initOptionParams (String appId, String appKey, String secretKey,String sn) {
        this.APPID = appId;
        this.APIKEY = appKey;
    ...
    if (SN == null) {
          ...
          InitConfig initConfig = new InitConfig(APPID, APIKEY, SECRETKEY,SN,ttsMode, params, listener);
        }
